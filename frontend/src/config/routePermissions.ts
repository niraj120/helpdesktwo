...
export const superAdminRoutes: RoutePermission[] = [
  ...
  {
    path: "/ivr-agents",
    permission: "IVR_AGENT_MANAGE",
    description: "IVR Agent Management — digit mapping, round-robin, leaves",
  },
  {
    path: "/tickets/assign",
...
export const projectPortalRoutes: RoutePermission[] = [
  ...
  {
    path: "/:customUrlPath/portal/service-requests",
    permission: [
      "SR_VIEW_ALL",
      "SR_VIEW_OWN",
      "SR_VIEW_ASSIGNED",
      ...
      "SR_CONFIG_MANAGE",
      "SR_ASSIGN_EMAILS",
      "SR_PRIORITY_OVERRIDE",
      "SR_OFFLINE_ENTRY",
      "EMAIL_TRIAGE_ACCESS",
      "EMAIL_TRIAGE_CONVERT",
      "EMAIL_TRIAGE_RESPOND",
      "IVR_TRIAGE_ACCESS",
      "IVR_TRIAGE_CONVERT",
    ],
    description: "Project service requests - requires SR/triage permissions",
  },
  {
