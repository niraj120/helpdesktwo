...
const ProjectForgotPassword = lazy(
  () => import("./pages/ProjectForgotPassword"),
);
...
const SimpleStudentDashboard = lazy(
...
const ConditionalStudentLayout = lazy(
  () => import("./components/ConditionalStudentLayout"),
);
...
const KBLevelManagementPage = lazy(
  () => import("./pages/KBLevelManagementPage"),
);
const KBArticleManagementPage = lazy(
  () => import("./pages/KBArticleManagementPage"),
);
const KBTableManagementPage = lazy(
  () => import("./pages/KBTableManagementPage"),
);
...
const FeedbackFormManagement = lazy(
  () => import("./components/FeedbackFormManagement"),
);
...
const CenterAssetMappingAccordion = lazy(
  () => import("./components/CenterAssetMappingAccordion"),
);
const MyAssets = lazy(() => import("./components/MyAssets"));
const FindCenterPage = lazy(() => import("./pages/FindCenterPage"));

// Offline Module
const OfflineModuleSettings = lazy(
  () => import("./pages/OfflineModuleSettings"),
);
const OfflineModuleConfigPage = lazy(
  () => import("./pages/OfflineModuleConfigPage"),
);
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route
            ...
            element={<ProjectPortalLogin />}
          />
          <Route
            path="/:customUrlPath/portal/forgot-password"
            element={<ProjectForgotPassword />}
          />
          <Route
            path="/:customUrlPath/forgot-password"
        ...
        /> */}
          ...
          <Route
            ...
            element={
              <ProtectedRoute
                permission={[
                  "AUDIT_VIEW_WEBHOOK_FAILURES",
                  "AUDIT_VIEW_INTEGRATION_FAILURES",
                ]}
              >
                <WebhookFailureLogs />
              </ProtectedRoute>
