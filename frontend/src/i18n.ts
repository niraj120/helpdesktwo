...
const resources = {
  en: {
    translation: {
      ...
      fillFormToSubmit:
        "Fill out the form below to submit your query. We'll respond as soon as possible.",
      ...
      querySubmittedMessage:
        "Our team will review your query and respond within 24-48 hours.",
      ...
      map: "Map",
      locateCentersText:
        "Locate our centers across the country or view them on the map",
      searchByCity: "Search by district...",
      searchByPincode: "Search by pincode...",
      searchPlaceholder: "Search by district, state, or pincode...",
      sortBy: "Sort By",
      ...
      searchForArticles: "Search Article",
      ...
      portalNotFoundMessage:
        "The portal you're looking for doesn't exist or the URL may be incorrect.",
  ...
  hi: {
    translation: {
      ...
      map: "नक्शा",
      locateCentersText:
        "देश भर में हमारे केंद्रों का पता लगाएं या उन्हें नक्शे पर देखें",
      searchByCity: "जिले के अनुसार खोजें...",
      searchByPincode: "पिनकोड के अनुसार खोजें...",
      searchPlaceholder: "जिला, राज्य या पिनकोड के अनुसार खोजें...",
      ...
      portalNotFoundMessage:
        "आप जिस पोर्टल की तलाश कर रहे हैं वह मौजूद नहीं है या URL गलत हो सकता है।",
      ...
      dashboardUpdatedRealtime:
        "डैशबोर्ड आंकड़े वास्तविक समय में अपडेट होते हैं और आपकी पहुंच अनुमतियों के आधार पर डेटा दिखाते हैं।",
  ...
  mr: {
    translation: {
      ...
      searchByCity: "जिल्ह्यानुसार शोधा...",
      searchByPincode: "पिनकोडनुसार शोधा...",
      searchPlaceholder: "जिल्हा, राज्य किंवा पिनकोडनुसार शोधा...",
      ...
      discoverKnowledgeBase:
        "उत्तरे, मार्गदर्शक आणि संसाधने शोधा जे तुम्हाला यशस्वी होण्यास मदत करतील",
      articles: "लेख",
      tables: "तालिका",
      all: "सर्व",
      ...
      portalNotFoundMessage:
        "तुम्ही शोधत असलेले पोर्टल अस्तित्वात नाही किंवा URL चुकीचा असू शकतो.",
      ...
      dashboardUpdatedRealtime:
        "डॅशबोर्ड आकडेवारी रिअल-टाइममध्ये अपडेट केली जाते आणि तुमच्या प्रवेश परवानग्यांवर आधारित डेटा दाखवते.",
