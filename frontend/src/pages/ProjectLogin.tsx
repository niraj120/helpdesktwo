...
interface ProjectBranding {
  ...
  sso?: {
    enabled: boolean;
    keycloak: SsoKeycloakConfig | null;
  };
}
    ...
    try {
      ...
      if (result.success) {
        ...
        localStorage.setItem(
          "userRole",
          result.data.user.role?.code || result.data.user.role,
        );
        ...
        >
          ...
          >
            {projectBranding.footerText ||
              `© 2025 ${projectBranding.name}. All rights reserved.`}
          </div>
        </div>
          ...
          >
            <div style={{ width: "100%", maxWidth: "440px" }}>
              ...
              >
                ...
                >
                  ...
                  <div style={{ textAlign: "right" }}>
                    <button
                      ...
                      onClick={() =>
                        alert(
                          "Forgot password flow not implemented for project login yet",
                        )
                      }
                      style={{
                        background: "none",
                ...
                {/* SSO Login Button */}
                {projectBranding.sso?.enabled &&
                  projectBranding.sso.keycloak && (
                    <>
                      <div
                        style={{
                          display: "flex",
