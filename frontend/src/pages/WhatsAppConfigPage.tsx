 ...
 */
const TRIGGER_TEMPLATE_VARIABLES: Record<
  string,
...
> = {
  ...
  studentOTP: [{ order: 1, name: "otpCode", description: "6-digit OTP code" }],
};
...
const WhatsAppConfigPage: React.FC = () => {
      ...
      if (config) {
        setConfig({
          ...
          triggers: {
            ...config.triggers,
            [selectedTrigger]: {
              ...config.triggers[selectedTrigger],
              ...triggerEdits,
            },
          },
        });
  ...
  const updateTriggerField = async (
    triggerKey: string,
    field: string,
    value: string,
  ) => {
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 mt-2">
          Please select a project to configure WhatsApp.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {config.apiBaseUrl ? "Configured" : "Not configured"} - Click to{" "}
                {showApiSettings ? "collapse" : "expand"}
              </p>
            </div>
          </div>
          <svg
          ...
          <div className="px-6 pb-6 border-t border-gray-100">
            <div className="grid grid-cols-1 gap-4 mt-4">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Base URL for WhatsApp API. The Number ID will be appended to
                  this URL.
                </p>
              </div>
            ...
            <div className="mt-4 p-3 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>API URL Format:</strong>{" "}
                {config.apiBaseUrl || "https://crmapi.wa0.in/api/meta/v19.0"}/
                {"{numberId}"}/messages
              </p>
              <p className="text-xs text-blue-600 mt-1">
                Each template has its own Number ID that is provided after
                WhatsApp approval.
              </p>
            </div>
      ...
      {testResult && (
        <div
          className={`p-4 rounded-lg flex items-center gap-3 ${testResult.success ? "bg-green-50 text-green-800" : "bg-red-50 text-red-800"}`}
        >
          {testResult.success ? (
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-100">
          ...
          <p className="text-sm text-gray-500">
            Configure WhatsApp templates for each event. Each template requires
            a pre-approved Number ID.
          </p>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateTriggerField(key, "numberId", e.target.value)
                        }
                  ...
                  {TRIGGER_TEMPLATE_VARIABLES[key] && (
                    ...
                    >
                      ...
                      {TRIGGER_TEMPLATE_VARIABLES[key].length} params)
                    </button>
                  )}
                </div>
                ...
                <div className="flex flex-col items-end gap-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        toggleTriggerEnabled(key, e.target.checked)
                      }
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">
                  Pre-approved Number ID from WhatsApp. This is used in the API
                  URL path.
                </p>
              </div>
              ...
              {TRIGGER_TEMPLATE_VARIABLES[selectedTrigger] && (
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <p className="text-xs text-blue-700 mb-3">
                    When creating your template in WhatsApp Business, use these
                    placeholders:
                  </p>
                  <div className="space-y-1">
                    {TRIGGER_TEMPLATE_VARIABLES[selectedTrigger].map(
                      (variable) => (
                        <div
                          key={variable.order}
