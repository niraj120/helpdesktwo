...
const ProjectDashboard = ({ wrapWithLayout = true }: ProjectDashboardProps) => {
  ...
  const handleViewModeChange = (newMode: ViewMode) => {
    console.log(
      "📊 ProjectDashboard: Switching view mode from",
      viewMode,
      "to",
      newMode,
    );
  ...
  const cards = [
    ...
    {
      title: stats.priorityLabels?.high
        ? `${stats.priorityLabels.high} Priority`
        : "High Priority",
    ...
    {
      title: stats.priorityLabels?.medium
        ? `${stats.priorityLabels.medium} Priority`
        : "Medium Priority",
    ...
    {
      title: stats.priorityLabels?.low
        ? `${stats.priorityLabels.low} Priority`
        : "Low Priority",
        ...
        >
          ...
          <p style={{ fontSize: "14px", color: "#6B7280", margin: 0 }}>
            ...
            {stats.totalTickets === 0 &&
              !loading &&
              "No queries found for this project yet."}
          </p>
        </div>
      </div>
    </div>
