...
export const setupSocketHandlers = (io: Server) => {
  ...
  io.on('connection', (socket: Socket) => {
    console.log(`✅ Socket connected: ${socket.id} userId=${socket.data.userId || 'anon'}`);
 ...
 */
export const emitTicketListUpdate = (io: Server, projectId: string, payload: {
 ...
 */
export const emitUserNotification = (io: Server, userId: string, payload: any) => {
